// src/components/editor/forms/CreatureEditForm.tsx
...
export default function CreatureEditForm(props: {
  draft: CreatureDraft;
  setDraft: React.Dispatch<React.SetStateAction<CreatureDraft>>;
  allSubs: string[];
}) {
